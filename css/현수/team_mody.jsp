...
<body>
	<div class="login">
		 ...
		 <form action="" method="post">
		 	...
		 	<div>
		 		<span class="team_textarea">팀 소개글</span>
		 		<span><textarea rows="5" cols="40">팀 소개글 : </textarea></span>
		 	</div><br/>
		 	<div>
		 		<span class="team_textarea">팀 매너</span>
		 		<span><textarea rows="5" cols="40">팀 매너 : </textarea></span>
		 	</div><br/>
		 	<div>
		 		<span>팀 앰블럼</span>
