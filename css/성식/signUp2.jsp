		...
		<form action="" method="post">
			...
			<div class="form-group">
				<label>아이디</label><input type="text" name="id" class="form-control"
					id="contact-name" placeholder="아이디입력" maxlength="15">
				<button type="submit" class="btn-theme">중복확인</button>
			...
			<div class="form-group">
				<label>패스워드확인</label><input type="password" name="confirmPw"
					class="form-control" id="contact-confirmPw" placeholder="패스워드확인입력"
					maxlength="20">
				<div class="validate"></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>별명</label><input type="text" name="nickname"
					class="form-control" id="contact-nickname" placeholder="별명입력"
					maxlength="30">
				<div class="validate"></div>
			</div>
			<div class="form-group">
				<label>전화번호</label><input type="tel" name="tel" class="form-control"
			...
			<div class="form-group">
				...
				<div class="validate">
					<div>
						<span>남자<input type="radio" name="gender" class=""
							id="contact-gender"></span> <span>여자<input type="radio"
							name="gender" class="" id="contact-gender"></span>
					</div>
				</div>
			</div>
			<div class="form-group">
				<label>생년월일</label><input type="date" name="birth"
					class="form-control" id="contact-birth" placeholder="생년월일">
				<div class="validate"></div>
			</div>
			<div class="form-group">
				<label>주소</label><br /> <input id="postcode1" type="text" value=""
					style="width: 50px;" readonly /> &nbsp;-&nbsp; <input
					id="postcode2" type="text" value="" style="width: 50px;" readonly />
				&nbsp;&nbsp; <input id="zonecode" type="text" value=""
					style="width: 50px;" readonly /> &nbsp; <input type="button"
					onClick="openDaumZipAddress();" value="주소 찾기" class="btn-theme" />
				<br /> <input type="text" id="address" class="form-" value=""
					style="width: 230px;" readonly /> <input type="text"
					id="address_etc" value="" style="width: 260px;" />
			</div>
			<div class="form-group">
				<label>이메일</label> <input type="email" name="email"
					class="form-control" id="contact-email" placeholder="이메일 입력"
					data-rule="email" data-msg="Please enter a valid email"
					maxlength="35">
				<div class="validate"></div>
			</div>
			<div class="form-group">
				<span><input type="text" name="certification"
					class="form-control" id="contact-cf" placeholder="인증하기"
					maxlength="10">
					<button type="submit" class="btn-theme">인증하기</button></span>
				<div class="validate"></div>
			</div>
